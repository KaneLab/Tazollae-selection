...
outdir=/home/liam/data/main_pipeline/pseudogene_analyses
mkdir $outdir
cd $outdir
...
## p-value!
Rscript --vanilla /home/liam/scripts/helper/binom_test_p_val.R x=$n_hogs_pseudo n=$n_hogs_present p=${global_percent_positive} outfile=p_val_col.tmp
## category definition!
