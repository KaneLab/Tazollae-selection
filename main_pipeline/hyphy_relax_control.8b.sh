...
## Set variables
main_dir=/home/liam/data/main_pipeline/relax_control
...
cd /home/liam/data/main_pipeline/relax_control
...
while read x n p; do
## Call R binom.test()
Rscript --vanilla /home/liam/scripts/helper/binom_test_p_val.R x=$x n=$n p=$p outfile=p_val_col.tmp
done
