...
cd /home/liam/data/main_pipeline/core_vs_shell_analyses/intact
> missing_core_annotations.tsv
cat Taz_absent_free_core.list Taz_shell_free_core.list | \
while read hog; do
echo $hog >> missing_core_annotations.tsv;
cat /home/liam/data/main_pipeline/annotations/eggnog-mapper_out/hog_annotations/${hog}_annotations.tsv | \
...
cd /home/liam/data/main_pipeline/annotations/eggnog-mapper_out/hog_annotations
> ccm.tmp
...
core_list_dir=/home/liam/data/main_pipeline/core_vs_shell_analyses/HOG/intact
unique_annotation_list_dir=/home/liam/data/main_pipeline/annotations/eggnog-mapper_out/hog_annotations
...
mkdir /home/liam/data/main_pipeline/hyphy_out/relax_out/core_only
...
cd /home/liam/data/main_pipeline/hyphy_out/relax_out/core_only
mkdir $hog_set
cd $hog_set
## Want to recalculate FDR q-values as set is smaller.
head -n 1 /home/liam/data/main_pipeline/hyphy_out/relax_out/results_no_FDR.tsv > results_no_FDR.tsv
tail -n +2 /home/liam/data/main_pipeline/hyphy_out/relax_out/results_no_FDR.tsv | \
grep -Ff $hog_list \
>> results_no_FDR.tsv
...
echo "full_analysis_trinary_percents.tsv,/home/liam/data/main_pipeline/hyphy_out/relax_out/results.tsv
