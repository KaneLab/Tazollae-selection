...
annotation_file=/home/liam/data/main_pipeline/annotations/eggnog-mapper_out/online_intact_annotations/out.emapper.annotations
tool=eggnog-mapper_out

## Split the eggnog-mapper outfile by prefix to speed up search below.
cd /home/liam/data/main_pipeline/annotations/${tool}
...
locus_list_dir=/home/liam/data/main_pipeline/orthofinder_out/for_downstream/locus_lists_HOGs
## Loop through hogs
...
cd /home/liam/data/main_pipeline/annotations/${tool}/hog_annotations
...
KEGG_modules_table=/home/liam/KEGG_module_kos.tsv
KEGG_pathways_table=/home/liam/KEGG_pathway_kos.tsv
