...
cd ~/sandbox
mkdir /home/liam/data/main_pipeline/RefSeq_vs_prokka
outdir=/home/liam/data/main_pipeline/RefSeq_vs_prokka/pseudofinder_out
mkdir $outdir
indir=/home/liam/data/refseq_Nostocales_genomes/data
conda deactivate
...
outdir=/home/liam/data/main_pipeline/RefSeq_vs_prokka/orthofinder_out
mkdir $outdir
...
while read long_prefix short_prefix; do
## RefSeq
cp /home/liam/data/main_pipeline/RefSeq_vs_prokka/pseudofinder_out/${long_prefix}/${long_prefix}_intact.faa ${indir}/${short_prefix}_RefSeq.fasta
## prokka
cp /home/liam/data/main_pipeline/pseudofinder_out/${long_prefix}/${long_prefix}_intact.faa ${indir}/${short_prefix}_prokka.fasta
done
## Get the outgroup fastas and rename (these did not pass through pseudofinder)
cat ~/outgroup.shortened.tsv | \
while read long_prefix short_prefix; do
## RefSeq
cp /home/liam/data/outgroup_refseq/${long_prefix}/protein.faa ${indir}/${short_prefix}_RefSeq.fasta
## prokka
cp /home/liam/data/main_pipeline/prokka_out/${long_prefix}/${short_prefix}.faa ${indir}/${short_prefix}_prokka.fasta
done
## Run orthofinder!
...
initial_orthofinder_outdir=/home/liam/data/main_pipeline/RefSeq_vs_prokka/orthofinder_out/initial_run/Results_Aug18
...
orthofinder_outdir=/home/liam/data/main_pipeline/RefSeq_vs_prokka/orthofinder_out/final_run
orthofinder_downstream_dir=/home/liam/data/main_pipeline/RefSeq_vs_prokka/orthofinder_out/for_downstream
...
## Note that the long vs. short prefix thing is a bit funny for this RefSeq vs prokka pipeline so be careful!
this_pseudofinder_outdir=/home/liam/data/main_pipeline/RefSeq_vs_prokka/pseudofinder_out
main_pseudofinder_outdir=/home/liam/data/main_pipeline/pseudofinder_out
new_pseudofinder_outdir=/home/liam/data/main_pipeline/RefSeq_vs_prokka/tmp_pseudofinder_out
...
## Inputs:
outdir=/home/liam/data/main_pipeline/RefSeq_vs_prokka/assign_pseudogenes
N=N13
prefix_tsv=/home/liam/data/main_pipeline/RefSeq_vs_prokka/N13.short_short.tsv
pseudofinder_outdir=/home/liam/data/main_pipeline/RefSeq_vs_prokka/tmp_pseudofinder_out
orthofinder_downstream_dir=/home/liam/data/main_pipeline/RefSeq_vs_prokka/orthofinder_out/for_downstream
...
mkdir /home/liam/data/main_pipeline/RefSeq_vs_prokka/orthofinder_out/for_downstream/aminoAcid_HOGs
mkdir /home/liam/data/main_pipeline/RefSeq_vs_prokka/orthofinder_out/for_downstream/nucleotide_HOGs
## Loop through the genome pairs
RefSeq_prokka_analysis_dir=/home/liam/data/main_pipeline/RefSeq_vs_prokka/analyses
mkdir $RefSeq_prokka_analysis_dir
orthofinder_downstream_dir=/home/liam/data/main_pipeline/RefSeq_vs_prokka/orthofinder_out/for_downstream
## Create a list of the genomes in N13
cd $RefSeq_prokka_analysis_dir
infile=/home/liam/data/main_pipeline/RefSeq_vs_prokka/orthofinder_out/final_run/Phylogenetic_Hierarchical_Orthogroups/N13.tsv
> N13_prefixes.tmp
head -n 1 $infile | \
...
pseudofinder_refseq_dir=/home/liam/data/main_pipeline/RefSeq_vs_prokka/pseudofinder_out/$long_prefix
pseudofinder_prokka_dir=/home/liam/data/main_pipeline/pseudofinder_out/$long_prefix
...
mkdir $short_prefix
cd $short_prefix
indir=/home/liam/data/main_pipeline/RefSeq_vs_prokka/orthofinder_out/input_fastas
...
mkdir $short_prefix
cd $short_prefix
refseq_indir=/home/liam/data/main_pipeline/RefSeq_vs_prokka/pseudofinder_out/$long_prefix
prokka_indir=/home/liam/data/main_pipeline/pseudofinder_out/$long_prefix
tail -n +2 ${RefSeq_prokka_analysis_dir}/${short_prefix}/comparison_cols.tsv | \
awk -F "\t" '{print $1}' | \
while read hog; do
> ${hog}.ffn
...
this_prokka_locus=$(\
cat /home/liam/data/main_pipeline/RefSeq_vs_prokka/orthofinder_out/for_downstream/N13_noOutgroups_original.tsv | \
awk -v hog=$hog -v prokka=$prokka -F "\t" '
NR==1 { for (i=4;i<=NF;++i) { if ( $i == prokka ) { c=i; next } } };
$1 == hog {print $c; exit}
'\
...
indir=/home/liam/data/main_pipeline/RefSeq_vs_prokka/orthofinder_out/for_downstream/nucleotide_HOGs/$short_prefix
...
ls /home/liam/data/main_pipeline/RefSeq_vs_prokka/orthofinder_out/for_downstream/nucleotide_HOGs/${short_prefix}/N13*.ffn | \
while read fasta; do
...
RefSeq_prokka_analysis_dir=/home/liam/data/main_pipeline/RefSeq_vs_prokka/analyses
refseq_genome_dir=/home/liam/data/refseq_Nostocales_genomes/data
refseq_pseudofinder_dir=/home/liam/data/main_pipeline/RefSeq_vs_prokka/pseudofinder_out
prokka_pseudofinder_dir=/home/liam/data/main_pipeline/pseudofinder_out
