...
outdir=/home/liam/data/main_pipeline/hyphy_out/concatenated_msas
...
> $msa_file
grep -vFf /home/liam/data/main_pipeline/hyphy_out/msas/msas_with_exclamation_marks.list \
/home/liam/data/main_pipeline/orthofinder_out/for_downstream/single_copy_genes.list | \
while read hog; do
cat /home/liam/data/main_pipeline/hyphy_out/msas/${hog}.noStop.fa | \
...
cat /home/liam/Taz.short_prefix.list | \
...
hyphy /home/liam/tools/hyphy/hyphy-analyses/FitMG94/FitMG94.bf --alignment $msa_file --tree $tree_file --type local --output $outfile > $stdoutfile
...
hyphy /home/liam/tools/hyphy/hyphy-analyses/FitMG94/FitMG94.bf --alignment $msa_file --tree $tree_file --type local  --srv Yes --starting-points 10 --output $outfile > $stdoutfile
...
cd /home/liam/data/main_pipeline/hyphy_out/concatenated_msas
