...
mkdir /home/liam/data/chloroplast_genes
mkdir /home/liam/data/chloroplast_genes/Dijkhuizen_SRAs

## Downloaded the raw reads from ENA for Dijkhuizen T. az. assemblies
cd /home/liam/data/chloroplast_genes/Dijkhuizen_SRAs
...
mkdir /home/liam/data/chloroplast_genes/chloroplast_genes
cd /home/liam/data/chloroplast_genes/chloroplast_genes
...
adapterFile=/home/liam/miniconda3/envs/trimmomatic/share/trimmomatic-0.39-2/adapters/TruSeq3-PE-2.fa
...
mkdir /home/liam/data/chloroplast_genes/bwa_mem_out
cd /home/liam/data/chloroplast_genes/bwa_mem_out
conda deactivate
conda activate samtools
## Put the 3 reference genomes together in one fasta
cat /home/liam/data/refseq_Nostocales_genomes/data/NostocAzollae0708/NostocAzollae0708.fna \
/home/liam/data/reference/plantRefGenome_inclChlp.fasta \
> reference.fasta
## simplify the headers
cat reference.fasta | awk '{print $1}' > tmp
mv tmp reference.fasta

indir=/home/liam/data/chloroplast_genes/Dijkhuizen_SRAs
...
mkdir /home/liam/data/chloroplast_genes/filtered_reads
cd /home/liam/data/chloroplast_genes/filtered_reads
conda deactivate
sam_dir=/home/liam/data/chloroplast_genes/bwa_mem_out
reads_dir=/home/liam/data/chloroplast_genes/Dijkhuizen_SRAs
cat ~/Dijkhuizen.prefix.list | \
while read prefix; do
...
## ASSEMBLE!
indir=/home/liam/data/chloroplast_genes/filtered_reads
mkdir /home/liam/data/chloroplast_genes/assemblies
cd /home/liam/data/chloroplast_genes/assemblies
conda deactivate
conda activate spades
cat ~/Dijkhuizen.prefix.list | \
while read prefix; do
/home/liam/miniconda3/envs/spades/bin/spades.py --meta -o $prefix -1 ${indir}/${prefix}_filtered_1P.fq.gz -2 ${indir}/${prefix}_filtered_2P.fq.gz
done
conda deactivate
...
outdir=/home/liam/data/chloroplast_genes/prokka_out
mkdir $outdir
cd $outdir
cat ~/Dijkhuizen.prefix.list | \
while read prefix; do
## Change the headers to contain the prefix and the spades node number
cat /home/liam/data/chloroplast_genes/assemblies/${prefix}/scaffolds.fasta | \
...
indir=/home/liam/data/chloroplast_genes/prokka_out
outdir=/home/liam/data/chloroplast_genes/pseudofinder_out
mkdir $outdir
cd $outdir
...
outdir=/home/liam/data/chloroplast_genes/orthofinder_out
mkdir $outdir
cd $outdir
...
pseudofinder_outdir=/home/liam/data/chloroplast_genes/pseudofinder_out
prokka_outdir=/home/liam/data/chloroplast_genes/prokka_out
cat ~/Dijkhuizen.prefix.list | \
while read prefix; do
...
initial_orthofinder_outdir=/home/liam/data/chloroplast_genes/orthofinder_out/initial_run/Results_Dec23
...
cd /home/liam/data/chloroplast_genes/orthofinder_out
...
orthofinder_outdir=/home/liam/data/chloroplast_genes/orthofinder_out/final_run
...
mkdir /home/liam/data/chloroplast_genes/orthofinder_out/for_downstream
cd /home/liam/data/chloroplast_genes/orthofinder_out/for_downstream
...
cd /home/liam/data/chloroplast_genes/orthofinder_out/for_downstream
main_pipeline_N9_noOutgroups=/home/liam/data/main_pipeline/orthofinder_out/for_downstream/N9_noOutgroups.tsv
...
grep -Ff unmatched_hogs_main_pipeline.list /home/liam/data/main_pipeline/orthofinder_out/for_downstream/Taz.n_intact.tsv | awk '$2>0' | awk '{ for (i=3;i<=NF;++i) { if ($i==0) {print $0; next} } }' | wc -l
...
> hogs_NosAzo0708.tmp
echo "\
/home/liam/data/main_pipeline/orthofinder_out/for_downstream,?
./,~\
" | \
sed 's/,/\t/g' | \
...
free_living,/home/liam/subtree_freeLiving.shortened.tsv\
" | \
sed 's/,/\t/g' | \
...
## set variables
outdir=/home/liam/data/chloroplast_genes/assign_pseudogenes
N=N9
prefix_tsv=~/subtree.shortened.tsv
orthofinder_downstream_dir=/home/liam/data/chloroplast_genes/orthofinder_out/for_downstream
pseudofinder_outdir=/home/liam/data/chloroplast_genes/pseudofinder_out
...
## Main pipeline
pseudofinder_dir=/home/liam/data/main_pipeline/pseudofinder_out
assign_pseudos_dir=/home/liam/data/main_pipeline/assign_pseudogenes
orthofinder_downstream_dir=/home/liam/data/main_pipeline/orthofinder_out/for_downstream
bash -i /home/liam/scripts/helper/identify_end_of_contig_pseudos.sh -p $pseudofinder_dir -a $assign_pseudos_dir -o $orthofinder_downstream_dir

## improve pipeline (this pipeline)
pseudofinder_dir=/home/liam/data/chloroplast_genes/pseudofinder_out
orthofinder_downstream_dir=/home/liam/data/chloroplast_genes/orthofinder_out/for_downstream
assign_pseudos_dir=/home/liam/data/chloroplast_genes/assign_pseudogenes
bash -i /home/liam/scripts/helper/identify_end_of_contig_pseudos.sh -p $pseudofinder_dir -a $assign_pseudos_dir -o $orthofinder_downstream_dir
...
main_pipeline_Taz_table=/home/liam/data/main_pipeline/orthofinder_out/for_downstream/Taz.n_intact_pseudo_w_end_of_contig.tsv
...
mv /home/liam/data/chloroplast_genes /home/liam/data/main_pipeline/improve_gene_inventory
...
metaspades_table=/home/liam/data/main_pipeline/improve_gene_inventory/metaspades_looseFilter/orthofinder_out/for_downstream/Taz.n_intact_pseudo_contig_ends_plus_improved.tsv
isospades_table=/home/liam/data/main_pipeline/improve_gene_inventory/isospades_looseFilter/orthofinder_out/for_downstream/Taz.n_intact_pseudo_contig_ends_plus_improved.tsv
...
intable=/home/liam/data/main_pipeline/orthofinder_out/for_downstream/free_living.n_intact_and_pseudo.tsv
...
cd /home/liam/data/main_pipeline/gene_loss
...
orthofinder_intact=/home/liam/data/main_pipeline/orthofinder_out/for_downstream/Taz.n_intact.tsv
