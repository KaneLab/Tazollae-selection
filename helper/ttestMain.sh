...
## liam@photobiont.colorado.edu:~/data/main_pipeline/RefSeq_vs_prokka/analyses
...
#scp paired_ttest_outputs.tsv prokka_length_ttest_outputs.tsv refseq_length_ttest_outputs.tsv liam@photobiont.colorado.edu:~/data/main_pipeline/RefSeq_vs_prokka/analyses
#cd ..
#rm -r analyses
