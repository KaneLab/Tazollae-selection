...
Rscript --vanilla /home/liam/scripts/helper/ape_ace_discrete_wrapper.R approach=$approach table_path=$table_path tree_path=$pruned_tree outfile=$R_outfile
...
awk '{print $1}' | \
while read hog; do
annotation_file=/home/liam/data/main_pipeline/annotations/eggnog-mapper_out/hog_annotations/${hog}_annotations.tsv
