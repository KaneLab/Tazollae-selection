...
subtree_list=/home/liam/Taz.short_prefix.list
outdir=Taz_subtree_no_gene_gain
approach=no_gain

bash -i /home/liam/scripts/helper/gene_loss_helper.sh -m $main_dir -b $binary_table\
...
in_tree=/home/liam/data/main_pipeline/orthofinder_out/final_run/Species_Tree/SpeciesTree_rooted_node_labels.txt
subtree_list=/home/liam/subtree.prefix.list
